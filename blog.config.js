...
const BLOG = {
  AUTHOR: 'FaintGhost', // 作者
  BIO: '一个普通的拉拉人', // 作者简介
  LINK: 'https://blog.k7s.cc', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '5b4f42c0f4f9466b90584b4e2f596034', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'zhang.yaowei@live.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/FaintGhost',
  CONTACT_TELEGRAM: '',
